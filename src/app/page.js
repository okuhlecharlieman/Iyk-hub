...
const FeatureSection = ({ title, icon, children, href }) => (
  <section className="bg-white dark:bg-gray-800/50 rounded-2xl shadow-lg p-6 md:p-8 border border-gray-200 dark:border-gray-700">
  ...
  return (
    <div className="px-4 sm:px-6 lg:px-8 py-12 md:py-16">
      <div className="max-w-7xl mx-auto space-y-20 md:space-y-28">
        ...
        {/* Hero Section */}
        <div className="text-center py-16 md:py-24 bg-gradient-to-b from-gray-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900/50 rounded-3xl shadow-inner-lg border border-gray-200 dark:border-gray-700">
        ...
        <section id="how-it-works" className="scroll-mt-24">
          <div className="text-center mb-12">
              ...
              <p className="mt-3 text-lg text-gray-500 dark:text-gray-400">Engage, earn points, and climb the leaderboard.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8 text-center">
              <div className="bg-white dark:bg-gray-800/50 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow border border-gray-200 dark:border-gray-700">
                  <FaGamepad className="text-4xl text-blue-500 mx-auto mb-5" />
                  <h3 className="text-xl font-bold mb-2">Play Games</h3>
                  <p className="text-gray-500 dark:text-gray-400">Challenge yourself with fun games and earn points for playing.</p>
              </div>
              <div className="bg-white dark:bg-gray-800/50 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow border border-gray-200 dark:border-gray-700">
                  <FaPaintBrush className="text-4xl text-teal-500 mx-auto mb-5" />
                  <h3 className="text-xl font-bold mb-2">Showcase Talent</h3>
                  <p className="text-gray-500 dark:text-gray-400">Share your art, music, or projects with the community.</p>
              </div>
              <div className="bg-white dark:bg-gray-800/50 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow border border-gray-200 dark:border-gray-700">
                  <FaBriefcase className="text-4xl text-yellow-500 mx-auto mb-5" />
                  <h3 className="text-xl font-bold mb-2">Find Opportunities</h3>
                  <p className="text-gray-500 dark:text-gray-400">Discover jobs, learnerships, and other opportunities.</p>
              </div>
          </div>
        </section>
        ...
        <FeatureSection title="New Opportunities" icon={<FaBriefcase />} href="/opportunities">
           {opps.length > 0 ? (
            <div className="space-y-4">
              {opps.map(o => (
                <Link key={o.id} href={o.link || '#'} target="_blank" rel="noopener noreferrer" className="block bg-gray-50 dark:bg-gray-700/50 p-5 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-all duration-200 border border-gray-200 dark:border-gray-600 hover:border-blue-400 dark:hover:border-blue-500">
