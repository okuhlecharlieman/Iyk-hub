...
import { FaTachometerAlt, FaTasks, FaUsers, FaSignOutAlt, FaHome, FaMoneyBillWave, FaCrown, FaTrophy } from 'react-icons/fa';
...
const AdminSidebar = () => {
  ...
  const links = [
    ...
    { href: '/sponsored-challenges', label: 'Challenges', icon: <FaTrophy /> },
  ];
