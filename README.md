...
Some games now support both **single-player and multiplayer game modes** (for example Tic-Tac-Toe and Rock-Paper-Scissors), with improved scoring feedback in the games hub.
