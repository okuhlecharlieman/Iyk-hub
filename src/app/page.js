      ...
      try {
        ...
        try {
          ...
          if (featuredRes.ok) {
            ...
            setFeaturedUsers(featuredData.featuredUsers || []);
          }
        } catch {}
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      ...
      {featuredUsers.length > 0 && (
        <div className="py-16 bg-gradient-to-r from-purple-50 to-blue-50 dark:from-gray-800/50 dark:to-gray-900/50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-10">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-3">Featured Creators</h2>
              <p className="text-lg text-gray-600 dark:text-gray-300">Ultra boosted creators making waves in our community</p>
            </div>
            <Swiper
              ...
              className="featured-creators-swiper pb-12"
            >
              {featuredUsers.map(user => (
                <SwiperSlide key={user.uid}>
                  <Link href={`/u/${user.uid}`} className="block bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 text-center hover:shadow-xl transition-all duration-300 hover:scale-[1.02] border border-gray-100 dark:border-gray-700">
                    <img src={user.photoURL || '/logo.png'} alt={user.displayName} className="w-20 h-20 rounded-full mx-auto mb-4 object-cover ring-4 ring-purple-200 dark:ring-purple-700" onError={(e)=>{ e.target.src='/logo.png'; }} />
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-1 line-clamp-2">{user.bio || 'Community Creator'}</p>
                  </Link>
                </SwiperSlide>
              ))}
            </Swiper>
