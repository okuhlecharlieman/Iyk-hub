...
import { FaEdit, FaSave, FaTimes, FaShieldAlt, FaUser, FaCamera, FaPalette, FaEye, FaExternalLinkAlt, FaChartLine } from 'react-icons/fa';
                ...
                <div className="mt-6 w-full">
                  {isEditing ? (
                    ...
                    <div className="space-y-4">
                      ...
                      <Link href={`/u/${user.uid}`} className="mt-4 inline-block text-sm text-purple-600 hover:underline">
                        <FaExternalLinkAlt className="inline-block mr-1" /> View Public Profile
                      </Link>
