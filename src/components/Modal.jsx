  ...
  return (
    ...
    >
      <div
        ...
        className="bg-white/80 dark:bg-gray-800/50 backdrop-blur-sm rounded-2xl shadow-xl w-full max-w-lg m-4 flex flex-col transform transition-all duration-300 scale-95 opacity-0 animate-fade-in-up border border-gray-200 dark:border-gray-700"
