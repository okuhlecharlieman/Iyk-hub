              ...
              <div className="mt-8">
                ...
                {posts.length > 0 ? (
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    {posts.map(post => (
                      <div key={post.id} className="bg-gradient-to-br from-blue-50 to-purple-50 dark:from-gray-700/50 dark:to-gray-600/50 rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow border-l-4 border-purple-200 dark:border-gray-600" style={{ borderLeftColor: accentColor || undefined }}>
                        {post.mediaUrl && (
                          <img src={post.mediaUrl} alt={post.title} className="w-full h-40 object-cover rounded-lg mb-3" onError={(e) => { e.target.style.display = 'none'; }} />
                        )}
